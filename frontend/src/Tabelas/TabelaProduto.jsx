              ...
              {produtos.map((produto) => {
                return (
                  <tr key={produto.codigo}>
                    ...
                    <td>{produto.tipo === 'Cartão de Crédito' || produto.tipo === 'Cartão de Débito' ? '--' : produto.valor}</td>
                    <td>{produto.tipo === 'Cartão de Crédito' || produto.tipo === 'Cartão de Débito' || produto.tipo === 'Seguro' ? '--' : produto.juros}%</td>
                    <td>
                      <Button
                        title='Alterar'
                        variant='primary'
                      ...
                      <Button
                        ...
                        variant='danger'
                        onClick={() => {
                          if (window.confirm('Deseja realmente excluir o produto ' + produto.nome + '?')) props.excluirProduto(produto);
                        }}
                      >
                        <Icone.Excluir />
                      </Button>
