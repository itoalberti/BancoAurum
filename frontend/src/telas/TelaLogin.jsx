    ...
    <Container className='d-flex align-items-center justify-content-center w-50'>
      <Form className='mt-5' onSubmit={realizarLogin}>
        ...
        <Form.Group className='mb-3'>
          ...
          <Form.Control required type='text' id='email' name='email' placeholder='usuario@provedor.com' value={usuario.email} onChange={manipulaMudanca} />
        </Form.Group>
        {/* Senha do usuário */}
        <Form.Group className='mb-3'>
          <Form.Label>Senha</Form.Label>
          <Form.Control required type='password' id='senha' name='senha' placeholder='' value={usuario.senha} onChange={manipulaMudanca} />
        </Form.Group>
