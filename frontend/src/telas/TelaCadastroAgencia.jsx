...
export default function TelaCadastroAgencia(props) {
  ...
  useEffect(() => {
    if (exibirTabela) consultarAgencia();
  }, [exibirTabela]);
    ...
    return (
      <div>
        <Pagina>
          ...
          <TabelaAgencia setExibirTabela={setExibirTabela} listaAgencias={listaAgencias} alterarAgencia={alterarAgencia} excluirAgencia={excluirAgencia} />
        </Pagina>
      </div>
    );
