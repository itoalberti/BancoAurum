...
export default class UsuarioCtrl {
  ...
  cadastrar(req, resp) {
    ...
    if (req.method === 'POST' && req.is('application/json')) {
      ...
      if (dados.tipo && dados.nome && dados.cpf && dados.rg && dados.genero && dados.telefone && dados.data_nascimento && dados.cep && dados.endereco && dados.cidade && dados.uf && dados.email && dados.senha && dados.agencia) {
        const usuario = new Usuario(0, dados.tipo, dados.nome, dados.cpf, dados.rg, dados.genero, dados.telefone, dados.data_nascimento, dados.cep, dados.endereco, dados.cidade, dados.uf, dados.email, dados.senha, dados.agencia);
        usuario
          .cadastrar()
          .then(() => {
  ...
  alterar(req, resp) {
    ...
    if (req.method === 'PUT' && req.is('application/json')) {
      const dados = req.body;
      if (dados.codigo && dados.tipo && dados.nome && dados.cpf && dados.rg && dados.genero && dados.telefone && dados.data_nascimento && dados.cep && dados.endereco && dados.cidade && dados.uf && dados.email && dados.senha && dados.agencia) {
        const usuario = new Usuario(dados.codigo, dados.tipo, dados.nome, dados.cpf, dados.rg, dados.genero, dados.telefone, dados.data_nascimento, dados.cep, dados.endereco, dados.cidade, dados.uf, dados.email, dados.senha, dados.agencia);
        usuario
          .alterar()
          .then(() => {
            resp.status(200).json({
